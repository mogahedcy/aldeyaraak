...
export const metadata: Metadata = {
  title:
    "محترفين الديار - خدمات شاملة في جدة | مظلات، برجولات، سواتر، ساندوتش بانل",
  description:
  ...
  openGraph: {
    ...
    description:
      "خبرة 15 عاماً في خدمات المظلات، البرجولات، السواتر، الساندوتش بانل، الترميم، تنسيق الحدائق، بيوت الشعر، والخيام الملكية في جدة",
    type: "website",
    locale: "ar_SA",
  },
  alternates: {
...
const structuredData = {
  ...
  description:
    "خدمات شاملة في جدة: مظلات، برجولات، سواتر، ساندوتش بانل، ترميم، تنسيق حدائق، بيوت شعر، خيام ملكية",
  ...
  sameAs: ["https://wa.me/+966553719009"],
  hasOfferCatalog: {
    "@type": "OfferCatalog",
    ...
    itemListElement: [
      ...
      },
      {
        ...
        itemOffered: {
          "@type": "Service",
          name: "ساندوتش بانل",
          description: "توريد وتركيب ساندوتش ��انل عالي الجودة",
        },
      },
      {
        "@type": "Offer",
